...
# Enter this in the Meta Dashboard "Verify Token" field.
...
# --- CONFIGURATION ---
# Using credentials to send replies
# Temp Token
...
async def webhook(request: Request):
    ...
    try:
        ...
        if messages:
            ...
            # --- AUTO REPLY LOGIC ---
            reply_text = f"Beep Boop! 🤖 I received message: '{message_body}'"
...
if __name__ == "__main__":
    ...
    print(f"Make sure to set Verify Token in Meta to: {VERIFY_TOKEN}")
